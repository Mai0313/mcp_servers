...
Click on [<kbd>Use this template</kbd>](https://github.com/Mai0313/mcp_servers/generate) to initialize a new repository, or use our initialization script for a personalized setup.
...
1. Click [<kbd>Use this template</kbd>](https://github.com/Mai0313/mcp_servers/generate)
...
1. Clone this repository
2. Globally replace `mcp_servers` with your project name (snake_case format)
3. Globally replace `MCPServers` with your project title (PascalCase format)
4. Run initial setup:
    ```bash
...
For detailed documentation, visit: [https://mai0313.github.io/mcp_servers/](https://mai0313.github.io/mcp_servers/)
